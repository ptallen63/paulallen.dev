...
import LaravalLogo from '../images/laraval.png'
...
export const workItems = [
  ...
  },
  {
    ...
    timeSpan: 'September 2018 - February 2019',
    bullets: [
      'Lead a team  of developers using technologies like ReactJS, VueJS, and other JS libraries to build frontend solutions',
    ]
  },
  ...
  {
    company: "University of South Carolina, Darla Moore School of Business",
    position: "Assitant Director of Recruiting",
    location: "Columbia, SC",
    timeSpan: "April 2013 - June 2016",
    bullets: [
      ...
      "Designed and programed all mass email communications sent to current and prospective PMBA  students",
      "Maintained and utilize the CRM system to enhance current recruiting and reporting efforts",
      ...
      "Developed and  manage social media strategies  for the PMBA program"
    ]
  },
  {
    company: "University of South Carolina, Darla Moore School of Business",
    position: "Consultant",
    location: "Columbia, SC",
    timeSpan: "November 2014 - June 2016",
    bullets: [
      "Led project to investigate potentially merging data systems across the college to leverage relational data",
      "Provided input into communication strategy for open & custom executive programs",
  ...
  },
  {
    ...
    location: "Birmingham, AL",
    timeSpan: "Summer 2005",
    bullets: []
  }
];

export const skills = [
  "Highly knowledgeable in Microsoft Word, Access, Publisher, and PowerPoint",
...
export const technologies = [
  {name: 'ReactJS', imgUrl: ReactLogo},
  {name: 'VueJS', imgUrl: VueLogo},
  {name: 'Javascript', imgUrl: JavascriptLogo},
  {name: 'NodeJS', imgUrl: NodeLogo},
  {name: 'PHP', imgUrl: PhpLogo},
  {name: 'HTML', imgUrl: HtmlLogo},
  {name: 'GraphQL', imgUrl: GraphqlLogo},
  {name: 'AWS', imgUrl: AwsLogo},
  {name: 'Git', imgUrl: GitLogo},
  {name: 'GulpJS', imgUrl: GulpLogo},
  {name: 'Webpack', imgUrl: WebpackLogo},
  {name: 'SCSS', imgUrl: ScssLogo},
  {name: 'Laraval', imgUrl: LaravalLogo},
]

export default { workItems, skills, honors, degrees, technologies };